...
MultiIni = (function() {
  ...
  MultiIni.prototype.read = function(filename) {
    ...
    handlers = [this.handleMultiLineStart, this.handleMultiLineEnd, this.handleMultiLineAppend, this.handleComment, this.handleSection, this.handleSingleLine];
  ...
  MultiIni.prototype.handleMultiLineStart = function(ctx, line) {
  ...
  MultiIni.prototype.handleMultiLineEnd = function(ctx, line) {
  ...
  MultiIni.prototype.handleMultiLineAppend = function(ctx, line) {
    if (!ctx.multiLineKeys || this.isMultiLineEnd(line)) {
      return false;
    }
    ctx.multiLineValue += '\n' + line;
